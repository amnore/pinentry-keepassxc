...
(This file describes the protocol used by KeePassXC browser integration, which is also used by the pinentry program. The original file can be found at [keepassxc-protocol.md](https://github.com/keepassxreboot/keepassxc-browser/blob/develop/keepassxc-protocol.md))
